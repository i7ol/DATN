...
export const APIS = [CartUserControllerService, OrderUserControllerService, PaymentUserControllerService, ProductUserControllerService, ShippingUserControllerService];
